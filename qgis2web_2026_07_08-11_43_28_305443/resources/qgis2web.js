...
map.getView().fit([12282122.963785, -875696.012468, 12291644.286916, -867012.312313], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">kepadatan penduduk</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (11 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'contoh peta';
            }
